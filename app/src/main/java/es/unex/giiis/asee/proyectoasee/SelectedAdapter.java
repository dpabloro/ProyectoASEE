...
public class SelectedAdapter extends RecyclerView.Adapter<SelectedAdapter.ViewHolder> {
    ...
    private static final String TAG = "SelectedAdapter-UserInterface";
    ...
    public SelectedAdapter(OnItemClickListener listener) {
    ...
    @Override
    public SelectedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
